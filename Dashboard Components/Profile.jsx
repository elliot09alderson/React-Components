...
const Profile = () => {
  return (
    <div className="select-none w-full p-10 flex flex-col  ">
      <div className=" grid grid-cols-1 sm:grid-cols-2 rounded-t-lg p-4 second-bg gap-8 ">
        <div className="h-full flex flex-col  gap-4  p-4">
          <h1 className="text-3xl mb-2 drop-shadow-md ">Company Details</h1>
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 p-4  second-bg gap-8 rounded-b-lg">
        <div className="h-full    flex flex-col  justify-center gap-4 p-4">
          <h1 className="text-3xl mb-2 drop-shadow-md">Document Details</h1>
